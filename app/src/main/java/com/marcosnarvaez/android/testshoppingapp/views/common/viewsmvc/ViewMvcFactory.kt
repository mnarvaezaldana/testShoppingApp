...
class ViewMvcFactory @Inject constructor(
    ...
    fun newProductDetailsViewMvc(parent: ViewGroup?): ProductsDetailsViewMvc {
        return ProductsDetailsViewMvc(layoutInflater, imageLoader, parent)
    }

    fun newProductLoginViewMvc(parent: ViewGroup?): ProductsLoginViewMvc {
        return ProductsLoginViewMvc(layoutInflater, parent)
    }
}